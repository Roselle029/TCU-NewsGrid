        ...
        <div>
          ...
          <select name="category_select" id="category_select">
            ...
            <?php
               ...
               function binary_search(array $categoryQuery, $result) {
                $min_index = 0;
                $max_index = count($categoryQuery) - 1;
                while ($min_index <= $max_index) {
                  $currentIndex = ($min_index + $max_index ) / 2 | 0; 
                  $currentElement = $categoryQuery[$currentIndex];
                  if ($currentElement == $result) {
                    return TRUE;
                  } else if ($currentElement < $result) {
                ...
                // Category Query to fetch all the categories from DB in using Binary Search Hexicographic order
